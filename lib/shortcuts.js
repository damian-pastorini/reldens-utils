...
class Shortcuts
{
    ...
    hasOwn(obj, prop)
    {
        if(this.isArray(prop) && 0 < prop.length){
            for(let value of prop){
                if(!this.hasProperty(obj, value)){
                    return false;
                }
            }
            return true;
        }
        return this.hasProperty(obj, prop) && 'undefined' !== typeof obj[prop];
    }
    ...
    hasProperty(obj, prop)
    {
        ...
        return this.hasAccessorProperty(obj, prop);
    }

    hasAccessorProperty(obj, prop)
    {
        for(let prototype = Object.getPrototypeOf(obj); prototype; prototype = Object.getPrototypeOf(prototype)){
            if(Object.prototype === prototype){
                return false;
            }
            let descriptor = Object.getOwnPropertyDescriptor(prototype, prop);
            if(descriptor){
                return 'function' === typeof descriptor.get;
            }
        }
        return false;
    }
